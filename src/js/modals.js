...
allBtnCards.forEach(btn => {
    btn.addEventListener("click", (e) => {
        ...
        if (card.id == "marketing") {
            ...
            modal.innerHTML =`
            <h3>Marketing</h3>
            <p>blogs, newsletters, photography and video <span style="color: white">content creation</span> according to the platforms we are working with.</p>`;
        } else if (card.id == "SEO") {
            modal.classList.add("show-modal");
            modal.id = "SEO-modal";
            cuerpo.style.overflow = "hidden";
            modal.innerHTML =`
            <h3>SEO</h3>
            <p style="color: #FFFFFF">SEO off-page and on-page <span style="color: #FF7223"> we can create a good strategy </span> for your business and make it work for you</p>`;
            ...
            <p style="color: #FFFFFF">posting commenting, and running the different <span style="color: #D9487D">accounts you may have</span></p>`;
